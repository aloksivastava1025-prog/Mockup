...
export const LOCATIONS = {
  studio: {
    label: 'Studio',
    background: { mode: 'gradient', colorTop: '#dedede', colorBottom: '#cfcfcf', groundVisible: true, surface: 'studio', groundColor: '#ffffff' },
  ...
  desk: {
    label: 'Desk',
    background: { mode: 'gradient', colorTop: '#d8cfc4', colorBottom: '#bdb0a1', groundVisible: true, surface: 'wood', groundColor: '#ffffff' },
  ...
  loft: {
    label: 'Loft',
    background: { mode: 'gradient', colorTop: '#b9bcc0', colorBottom: '#8e9297', groundVisible: true, surface: 'concrete', groundColor: '#ffffff' },
  ...
  marble: {
    label: 'Marble',
    background: { mode: 'gradient', colorTop: '#f2f1ef', colorBottom: '#dcdad6', groundVisible: true, surface: 'marble', groundColor: '#ffffff' },
  ...
  noir: {
    label: 'Noir',
    background: { mode: 'gradient', colorTop: '#1b1f27', colorBottom: '#05070a', groundVisible: true, surface: 'mirror', groundColor: '#0d0f14' },
  ...
  void: {
    label: 'Void',
    background: { mode: 'gradient', colorTop: '#e8e8e8', colorBottom: '#d2d2d2', groundVisible: false, surface: 'studio', groundColor: '#ffffff' },
